...
import { UserInfo } from '../../const/app.const';
...
const ScenarioASSET = ({ route, navigation }: any) => {
    ...
    const [userInput, setUserInput] = useState<
        Record<string, { name: string; count: string; image: string; status: string }>
    >({});
    ...
    const handleSave = async () => {
        ...
        console.log('User Input after update:', userInput);
