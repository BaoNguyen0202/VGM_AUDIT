...
import { KeyAbleProps } from '../modal';
...
export const Selector = {
    ...
    getSearchProductValue: (state: IAppReduxState) => state.appRedux.searchProductValue,
    getTheme: (state: IAppReduxState) => state.appRedux.theme,
    getSearchVisitValue: (state: IAppReduxState) => state.appRedux.searchVisitValue,
};
...
const setShowErrorModalStatus = (state = INITIAL_STATE, action: KeyAbleProps) => ({
    ...state,
    error: undefined,
    showModal: action.data,
});

const setSearchProductValue = (state = INITIAL_STATE, action: KeyAbleProps) => ({
    ...state,
