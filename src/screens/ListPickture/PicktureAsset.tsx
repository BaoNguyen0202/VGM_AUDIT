...
const PicktureAsset = ({ navigation, route }: any) => {
    ...
    const uploadImages = async (imageArray: any) => {
        try {
            ...
            while (imageArray.length > 0) {
                ...
                formData.append('doctype', 'ReportScenario_Asset');
                formData.append('fieldname', 'asset_image');
    ...
    const handleSave = async () => {
        ...
        navigation.navigate(ScreenConstant.SCENARIOASSET, { updatedProduct, scenarioName });
    };
    return (
