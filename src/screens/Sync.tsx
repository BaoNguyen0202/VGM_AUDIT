        ...
        <>
                        ...
                        <View style={styles.cardContent}>
                            ...
                            <View style={styles.rightContent}>
                                ...
                                <View style={styles.buttonContainer}>
                                    <Card.Actions>
                                        <Button mode="contained-tonal" onPress={() => showDialog(product.id)}>
                                            Delete
                                        </Button>
                                        <Button buttonColor="#1abc9c">Ok</Button>
                                    </Card.Actions>
                                </View>
                            </View>
                        </View>
            ...
            <Portal>
                <Dialog visible={visible} onDismiss={hideDialog}>
                    ...
                    <Dialog.Actions>
                        <Button textColor="#1abc9c" onPress={hideDialog}>
                            Cancel
                        </Button>
                        <Button textColor="#1abc9c" onPress={() => deleteProductById(selectedProductId)}>
                            Delete
                        </Button>
                    </Dialog.Actions>
                </Dialog>
